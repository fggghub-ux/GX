...
(function() {
    ...
    function normalizeMessageRecord(friendId, msg, index) {
        ...
        return {
            ...
            giftName: typeof safe.giftName === 'string' ? safe.giftName : '',
            giftValue: Number.isFinite(Number(safe.giftValue)) ? Number(safe.giftValue) : 0,
            giftDescription: typeof safe.giftDescription === 'string' ? safe.giftDescription : '',
            giftStatus: safe.giftStatus === 'received' ? 'received' : 'pending',
            giftPaymentMethod: typeof safe.giftPaymentMethod === 'string' ? safe.giftPaymentMethod : '',
    ...
    function denormalizeMessageRecord(row) {
        ...
        return {
            ...
            giftValue: Number(row.giftValue) || 0,
            giftDescription: row.giftDescription || '',
            giftStatus: row.giftStatus === 'received' ? 'received' : 'pending',
            giftPaymentMethod: row.giftPaymentMethod || '',
