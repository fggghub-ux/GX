...
class NetflixApp {
    ...
    createDefaultCatalog() {
        ...
        const items = [
            ...
            make('default-stage', 'Silk Road Shadow Gold', 'Financial Crime', 'On a Belt and Road project, funds flow into a Middle Eastern underground network through fraudulent trade. As a commercial counselor, you uncover links between your country’s executives and a terrorist financing group. Exposing them could trigger a diplomatic crisis.', 'u2-stage', ['Diplomatic', 'Geopolitics'])
        ];
