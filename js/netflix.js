...
class NetflixApp {
    ...
    createDefaultCatalog() {
        ...
        const items = [
            ...
            make('default-ancient-promise', 'Market Leak', 'Financial Crime', 'On the eve of a company’s merger, a message leaks hugely valuable insider information. As an SEC investigator, you have 48 hours to identify the source. The suspects include your mentor, your ex, and an untouchable power broker.', 'u2-ancient-promise', ['Insider Trading', 'Gray Areas']),
            make('default-island', 'Foreign Funds', 'Financial Crime', 'Behind a quiet teahouse in the Pearl River Delta operates an underground bank moving hundreds of billions a year. As an undercover officer inside, you’re caught between gang loyalty and the law. One botched transfer puts both sides after you.', 'u2-island-letter', ['Undercover', 'Organized Crime']),
            make('default-stage', 'Silk Road Funds', 'Financial Crime', 'On a Belt and Road project, funds flow into an Middle Eastern underground network through fraudulent trade. As a counselor, you uncover links between executives and a terrorist financing group. Exposing them could trigger a diplomatic crisis.', 'u2-stage', ['Diplomatic', 'Investigation'])
        ];
