...
class NetflixApp {
    ...
    createDefaultCatalog() {
        ...
        const items = [
            make('default-night-train', 'Vault Zero', 'Financial Crime', 'A private Swiss bank runs its annual asset audit at midnight and discovers dozens of anonymous safety deposit boxes have lost their records. No locks broken, no alarms triggered — every access trail shows no one ever entered. As the investigation deepens, a fund transfer scheme spanning Zurich and Singapore comes to light.', 'u2-night-train', ['Bank Heist', 'Financial Fraud']),
