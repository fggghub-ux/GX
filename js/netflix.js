...
class NetflixApp {
    ...
    createDefaultCatalog() {
        ...
        const items = [
            ...
            make('default-stage', 'Silk Road Funds', 'Financial Crime', 'On a Belt and Road project, funds flow into an underground network through fraudulent trade. As a counselor, you uncover links between executives and a terrorist financing group. Exposing them could trigger a diplomatic crisis.', 'u2-stage', ['Diplomatic', 'Investigation'])
        ];
